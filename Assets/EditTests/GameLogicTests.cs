...
namespace Marsion.Tests
{
    ...
    public class GameLogicTests
    {
        ...
        public void SetUp()
        {
            ...
            gameData = sessionFactory.CreateGameData();
            dataHandler = sessionFactory.CreateGameDataHandler(gameData);
            gameLogic = sessionFactory.CreateGameLogicEx(dataHandler);
        ...
        public void GameLogic_StartGame_Should_SetPlayers()
        {
            ...
            var tempGameLogic = new DefaultGameLogic(mockDataHandler.Object);
