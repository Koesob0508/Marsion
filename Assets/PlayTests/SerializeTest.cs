...
public class SerializeTest
{
    ...
    //    DefaultGameData originalGameData = new DefaultGameData(2); // 두 플레이어를 가진 게임 데이터 생성
    ...
    //    DefaultGameData deserializedGameData = NetworkTool.JsonDeserialize<DefaultGameData>(sdata.GetString());
